...
import useHandlerAddHampers from "../hooks/addHampers";
...
function AddHampersPage() {
  ...
  const { handlerAddHampers } = useHandlerAddHampers();
          ...
          <div key={i} className="grid grid-cols-3 gap-4">
            ...
            {selectedCategory === "Produk" ? (
              ...
              <div>
                <DropdownInput
                  value={
                    leadObj.id_bahan_baku[i] !== undefined
                      ? leadObj.id_bahan_baku[i]
                      : ""
                  }
